            ...
            <div class="auto-container">
                <div class="wrapper-box">
                    ...
                    <div class="cause-block-three style-two">
                        <div class="inner-box">
                            <div class="image">
                                <img src="{{ asset('frontend/images/local/boy-wearing.jpg') }}" alt="">
                            </div>
                    ...
                    <div class="cause-block-three style-two">
                        <div class="inner-box">
                            ...
                            <div class="content-wrapper">
                                ...
                                <div class="content">
                                    <h4><a href="cause-details.html">Clean Nagur</a></h4>
                                    <div class="text">Foresee the pain and trouble that bound <br>to ensue and equal blame </div>
                                    <ul class="info-box">
                                        <li><a href="#"><span>Raised:</span> <br><i>fa fa-bell</i></a></li>
                                        <li><a href="#"><span>Goal:</span> <br>$100000</a></li>
                                    </ul>
                                    <div class="donate-btn"><a href="#" class="theme-btn btn-style-eight donate-box-btn"><span>Donate Now</span></a></div>
                                </div>
                    ...
                    <div class="cause-block-three style-two">
                        <div class="inner-box">
                            <div class="image">
                                <img src="{{ asset('frontend/images/background/child-praying.jpg') }}" alt="">
                            </div>
                            <div class="content-wrapper">
                                <!--Progress Levels-->
                                <div class="progress-levels style-two">
